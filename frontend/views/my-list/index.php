...
<section class="menu-toggle">
    <ul class="menu-toggle__list">
        <li class="menu-toggle__item <?php if(Yii::$app->request->get('status') === 'success'): ?>menu_toggle__item--current <? endif; ?> menu-toggle__item--completed">
        ...
        <li class="menu-toggle__item <?php if(Yii::$app->request->get('status') === 'new' || Yii::$app->request->get('status') === null): ?>menu_toggle__item--current <? endif; ?> menu-toggle__item--new">
            <div class="menu-toggle__svg-wrapper">
        ...
        <li class="menu-toggle__item <?php if(Yii::$app->request->get('status') === 'in_work'): ?>menu_toggle__item--current <? endif; ?> menu-toggle__item--active">
            <div class="menu-toggle__svg-wrapper">
            ...
            <a href="?status=in_work">
                Активные
            </a>
        </li>
        <li class="menu-toggle__item <?php if(Yii::$app->request->get('status') === 'canceled'): ?>menu_toggle__item--current <? endif; ?> menu-toggle__item--canceled">
            <div class="menu-toggle__svg-wrapper">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="menu-toggle__item <?php if(Yii::$app->request->get('status') === 'failed'): ?>menu_toggle__item--current <? endif; ?> menu-toggle__item--hidden">
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="my-list__wrapper">
        ...
        <?php foreach ($tasks as $task): ?>
            <div class="new-task__card">
                ...
                <div class="task-status done-status" style="width: 97px"><?= \Task\classes\Task::MAP_STATUSES_NAME[$task->status]; ?></div>
                ...
                <div class="feedback-card__top ">
                    ...
                    <div class="feedback-card__top--name my-list__bottom">
                        <p class="link-name"><a href="<?= Url::to(['users/view', 'id' => $task->author->id]); ?>" class="link-regular"><?= $task->author->name; ?></a></p>
                        <a href="<?= Url::to(['tasks/view', 'id' => $task->id]); ?>" class="my-list__bottom-chat  my-list__bottom-chat--new">
                            <b><?= $task->getCountMessages(); ?></b>
                        </a>
                        <?= ViewRatingStars::getRating($task->author->profile->rating);  ?>
                        <b><?= $task->author->profile->rating; ?></b>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
